...
import static com.alex.linkmobility.messagingapp.commons.constant.RabbitMQConstants.MESSAGE_KEY;
import static com.alex.linkmobility.messagingapp.commons.constant.RabbitMQConstants.TOPIC_EXCHANGE_NAME;
...
public class SendMessageTask implements Runnable {
    ...
    public void run() {
        try {
            ...
            Message toSend = Message.generateRandomMessage();
